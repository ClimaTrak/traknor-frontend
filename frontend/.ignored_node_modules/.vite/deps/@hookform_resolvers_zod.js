import { appendErrors, get, set } from './chunk-4JDA7Q2S.js';
import './chunk-LTCMK76B.js';
import './chunk-5WWUZCGV.js';

// ../node_modules/.pnpm/@hookform+resolvers@3.10.0__a7b7e57e2af1f26c162f4e9e78603376/node_modules/@hookform/resolvers/dist/resolvers.mjs
var s = (e, s2, o2) => {
...
var o = (t2, e) => {
  for (const o2 in e.fields) {
    ...
    r2 && r2.ref && 'reportValidity' in r2.ref
      ? s(r2.ref, o2, t2)
      : r2.refs && r2.refs.forEach((e2) => s(e2, o2, t2));
  }
};
var r = (s2, r2) => {
  ...
  const f = {};
  for (const o2 in s2) {
    const n2 = get(r2.fields, o2),
      a = Object.assign(s2[o2] || {}, { ref: n2 && n2.ref });
...
// ../node_modules/.pnpm/@hookform+resolvers@3.10.0__a7b7e57e2af1f26c162f4e9e78603376/node_modules/@hookform/resolvers/zod/dist/zod.mjs
var n = function (r2, e) {
    ...
    function (i2, a, u) {
      try {
        return Promise.resolve(
          (function (e, n2) {
            try {
              var a2 = Promise.resolve(
                o2['sync' === s2.mode ? 'parse' : 'parseAsync'](i2, t2),
              ).then(function (e2) {
                return (
                  u.shouldUseNativeValidation && o({}, u),
                  { errors: {}, values: s2.raw ? i2 : e2 }
                );
              });
            } catch (r2) {
              return n2(r2);
